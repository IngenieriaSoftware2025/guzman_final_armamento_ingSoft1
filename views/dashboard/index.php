    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body bg-gradient p-5" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="text-center text-white">
                        <h1 class="fw-bold mb-3">
                            <i class="bi bi-speedometer2 me-3"></i>
                            DASHBOARD PRINCIPAL
                        </h1>
                        <p class="lead mb-4">Bienvenido al Sistema de Gestión de Armamento</p>
