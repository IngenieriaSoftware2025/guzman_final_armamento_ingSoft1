                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="/guzman_final_armamento_ingSoft/aplicacion" class="btn btn-primary">Acceder</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="/guzman_final_armamento_ingSoft/permisos" class="btn btn-primary">Acceder</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            ...
                            <a href="/guzman_final_armamento_ingSoft/asignacionpermisos" class="btn btn-primary">Acceder</a>
                        </div>
                    </div>
                </div>
            </div>
